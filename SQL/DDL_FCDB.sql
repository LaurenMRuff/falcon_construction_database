...
INSERT INTO `Customers` (`customer_id`, `customer_first_name`,`customer_last_name`,  `customer_email`, `customer_phone`,
                         `customer_company`, `customer_address`, `customer_city`, `customer_state`,`customer_zip_code`)
VALUES
    (1,'Laila','Robertson', 'lailarobertson@gmail.com','(581) 982-7934','Green-Lowe', '11 Brook St.', 'Hope Mills', 'NC', '23348'),
    (2,'Cristina','Murray', 'cristinamurray@gmail.com','(995) 323-768','Bradtke Group', '148 Ridge Avenue', 'Dickson', 'TN', '37055'),
    (3,'Hamza','Richards', 'hamzarichards@gmail.com','(276) 978-1218','Wisoky LLC', '158 Corona Street', 'Millville', 'NJ', '83321'),
    (4,'Mia','Shannon', 'miashannon@gmail.com','(522) 894-6880','Bartoletti and Sons', '2 Marlborough Rd.', 'Sarasota', 'FL', '34231'),
    (5,'Ishaan','Perkins', 'ishaanperkins@gmail.com','(817) 437-7014','Lind LLC', '21 Rock Creek Street', 'El Dorado', 'AR', '41730'),
    (6,'Lorena','Roy', 'lroy@gmail.com','(318) 442-6235','Turcotte, Murray and Hayes', '3 Rockwell Ave.', 'Royal Oak', 'MI', '48067'),
    (7,'Brett','Barrera', 'bbarrera@gmail.com','(542) 259-0411','Morar, Bashirian and Nader', '36 Mayfield Court', 'Fishers', 'IN', '46037'),
    (8,'Carsen','Lowe', 'clowe@gmail.com','(432) 613-7627','Kohler, Goldner and Schaden', '36 N. Deerfield Ave.', 'Bethel Park', 'PA', '15102'),
    (9,'Eliza','Moon', 'emoon@gmail.com','(809) 760-5081','Wisozk - Kassulke', '430 Old 8th Drive', 'Sidney', 'OH', '45365'),
    (10,'McKayla','Walker', 'mwalker@gmail.com','(311) 515-1073','Ferry, Jakubowski and Hessel', '460 Roosevelt Ave.', 'Boca Raton', 'FL', '33428'),
    (11,'Camron','Rivera', 'crivera@gmail.com','(316) 251-2083','Conn and Sons', '52 W. North Court', 'Owensboro', 'KY', '42301'),
    (12,'Addisyn','Flynn', 'aflynn@gmail.com','(453) 400-0361','Veum, Dietrich and Erdman', '548 North Cedar Swamp Ave.', 'South Windsor', 'CT', '60745'),
    (13,'Ivan','Scott', 'iscott@gmail.com','(204) 397-3707','Jenkins - Reynolds', '692 Constitution Lane', 'Bonita Springs', 'FL', '34135'),
    (14,'Hector','Mack', 'hmack@gmail.com','(769) 723-4219','Legros - Schimmel', '7008 South Harrison St.', 'Elkridge', 'MD', '21075'),
    (15,'Greta','Holden', 'gholden@gmail.com','(956) 967-8736','Austin Creative Solutions', '742 Spring Lane', 'Downers Grove', 'IL', '60515'),
    (16,'Amaris','Hoffman', 'amhof@gmail.com','(381) 283-9459','Smitham LLC', '7613 Pulaski Street', 'Coraopolis', 'PA', '15108'),
    (17,'Bella','Huffman', 'behuf@gmail.com','(973) 682-0297','Greenfelder, Hudson and Kohler', '7866 E. Ashley Ave.', 'Lake Mary', 'FL', '32746'),
    (18,'Selena','Finley', 'sefin@gmail.com','(502) 454-7075','Harris Inc', '856 Randall Mill Road', 'North Haven', 'CT', '64734'),
    (19,'Cash','Lynn', 'calyn@gmail.com','(527) 509-8838','Bogan, Reilly and Runolfsdottir', '8577 College Ave.', 'Pensacola', 'MA', '32503'),
    (20,'Keagan','Butler', 'kebut@gmail.com','(355) 959-2763','Krajcik LLC', '886 West St.', 'Fitchburg', 'MD', '14205'),
    (21,'Slade','Conrad', 'slcon@gmail.com','(936) 219-4685','Medhurst LLC', '89 Monroe St.', 'Dundalk', 'MD', '21222'),
    (22,'Kali','Hendricks', 'kalihendricks@gmail.com','(789) 756-7755','VonRueden - Kiehn', '90 Catherine Street', 'Oakland Gardens', 'NY', '11364'),
    (23,'Jordan','Pennington', 'jpennington@gmail.com','(525) 524-2074','Murphy, Lind and Jaskolski', '9113 Essex St.', 'Jackson', 'NJ', '85274'),
    (24,'Mareli','Fuller', 'mfuller@gmail.com','(484) 334-6413','Johnston, Watsica and Hettinger', '9502 E. Paris Hill Ave.', 'Grayslake', 'IL', '60030'),
    (25,'Francis','Ortiz', 'fortiz@gmail.com','(893) 524-1644','Hegmann, Hickle and Effertz', '964 Wilson Lane', 'Holly Spring', 'NC', '27540');
UNLOCK TABLES;
...
INSERT INTO `Jobs` (`job_id`, `fk_customer_id`, `fk_category_id`, `job_code`, `job_start_date`, `job_end_date`,
...
ON DUPLICATE KEY UPDATE `fk_category_id` = `fk_category_id`;
UNLOCK TABLES;
...
INSERT INTO `Job_Employees` (`job_employee_id`,`fk_job_id`,`fk_employee_id`)
VALUES 
(1,22,1),
(2,23,2),
(3,27,2),
