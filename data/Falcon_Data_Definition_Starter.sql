...
CREATE TABLE `Items` (
  `item_id` int(10) NOT NULL AUTO_INCREMENT UNIQUE,
  `item_name` varchar(255) NOT NULL,
  `item_description` varchar(255) NOT NULL,
  `item_cost_per_unit` int(10) NOT NULL,
  PRIMARY KEY (`item_id`)
  ) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;
...
(3,'Modular SF Home - 2/2','Flat cost of modular single family home of 2bed 2 bath',276000),
(4,'Highway Build','Standard cost for a 4 lane highway by mile',4450000),
(5,'Sports Facility Repair - Bathroom','Cost to repair a bathoroom',12500),
(6,'Sports Facility Repair - Tennis Courts','Cost to repair tennis courts',5500),
(7,'Walls Repair - Restaurant','Cost to repair one wall of a restaurant',1100),
(8,'Restoration - Restaurant Kitchen','Cost to restore restaurant kitchen - per square foot ',250),
(9,'Commercial  - Roof repair','Cost to repair a roof for a commericial facility - per square feet',12),
(10,'Parking lot repair','Cost to repair a commericial parking lot-per sqft',2),
(11,'Townhouse Build - 4 unit','Flat cost of a townhouse build with 4 units each with 4/2.5 ba and 1,500 sqft',725000),
(12,'Townhouse Build - 5 unit','Flat cost of a townhouse build with 5 units each with 4/2.5 ba and 1,500 sqft',900000),
(13,'Townhouse Build - Complex','Flat cost of a townhouse complex build each with 4/2.5 ba and 1,500 sqft',1100000),
(14,'Multi-family Build - Duplex 1000 sq ft','Flat cost of a duplex multi-family house (1000 sq ft) standard',215000),
(15,'Multi-family Build - Duplex 2000 sq ft','Flat cost of a duplex multi-family house (2000 sq ft) standard',350000),
(16,'Multi-family Build - Duplex 3000 sq ft','Flat cost of a duplex multi-family house (3000 sq ft) standard',420000),
(17,'Multi-family Build - Duplex 4000 sq ft','Flat cost of a duplex multi-family house (4000 sq ft) standard',550000),
(18,'Multi-family Build - Duplex 5000 sq ft','Flat cost of a duplex multi-family house (5000 sq ft) standard',650000),
(19,'Pothole repair','Highway pothole repair',40),
(20,'Shoulder repair - highway','Cost to repair a shoulder (1500 feet)',1801),
(21,'Repaving of highway','Standard cost of repaving 1/4 mile of highway',250000),
(22,'Pipeline Build','Standard cost of building a 30 inch pipeline - per mile',5340000),
(23,'Railway Maintenance','Standard cost of railway maintenance - per mile',15000),
(24,'Rail transit Station','Cost to build a rail station',150000000),
(25,'New Track Construction - Railway','Standard cost for constructing new railway - per mile',1500000),
(26,'Road Build - 2 lane','Cost for constructing a new 2-lane road - per foot',378),
(27,'Window repair','Repair cost of a Double pane window',350),
(28,'Piping repair','Flat repair cost of 1 pipe in a residential home',500),
(29,'Modular SF Home - 3/2','Flat cost of modular single family home of 3bed 2 bath',460000),
(30,'Condo Building - 2 Units','Flat cost of a condo building that have 2 units',250000),
(31,'Condo Building - 10 Units','Flat cost of a condo building that have 10 units',900000),
(32,'Condo Building - 20 Units','Flat cost of a condo building that have 20 units',2500000),
(33,'Condo Building - 50 Units','Flat cost of a condo building that have 50 units',6800000),
(34,'Condo Building - 100 Units','Flat cost of a condo building that have 100 units',12500000),
(35,'Condo Building - 200 Units','Flat cost of a condo building that have 200 units',25000000),
...
CREATE TABLE `Job_Items` (
  `job_item_id` int(10) NOT NULL AUTO_INCREMENT UNIQUE,
  `item_id` int(10) UNIQUE,
  `job_id` int(10) UNIQUE,
...
INSERT INTO `Job_Items` (`job_item_id`,`item_id`,`job_id`,`quantity`)
VALUES 
(1,1,27,2),
(2,2,28,3),
(3,3,29,1),
